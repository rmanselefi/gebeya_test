    ...
    <div class="products-section my-orders container">
        ...
        <div class="my-profile">
            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                ...
                <form class="uk-form-stacked" role="form" action="{{ route('dashboard.store') }}" method="POST"
                        ...
                        <div class="uk-grid-medium uk-child-width-1-1 uk-grid" uk-grid="">
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-grid-small uk-child-width-1-1 uk-child-width-1-2@s uk-grid" uk-grid="">
                                    ...
                                    <div>
                                        <label>
                                            <div class="uk-form-label">Slug</div>
                                            <input class="uk-input" type="text" name="slug">
                                        </label>
                                    </div>
                                    <div>
                                        <label>
                                    ...
                                    <div class="uk-accordion-content" aria-hidden="false">
                                        <ul class="uk-list tm-scrollbox">
                                            {{-- @for ($i = 0; $i < count($allCategories); $i++)
                                                <li>
                                                    <input class="tm-checkbox" id="brand-{{ $i }}"
                                                        name="category[]" value="{{ $allCategories[$i]->id }}"
                                                        type="checkbox"
                                                        {{ $categoriesForProduct->contains($allCategories[$i]) ? 'checked' : '' }}>
                                                    <label for="brand-{{ $i }}">
